...
const Certificates = () => {
  ...
  const certificates = [
    ...
    },
    {
      ...
      date: '2026',
      description: 'Certificate of Achievement for Innovation and Technological Advancement in Textile City Bhilwara.',
    ...
    },
    {
      ...
      date: '2024',
      description: "Participated as Team LOSE CODER'S in the Build & Submit - Prototype Development Round organised by Indian Institute of Science (IISc).",
      skills: ['Hackathon', 'Prototype Development', 'Problem Solving'],
      image: '/art-park-banglore.png',
      color: '#06b6d4',
